...
public class Config : MonoBehaviour
{
    ...
    public void Save()
    {
        Debug.Log("Running public void Save() in Config");
        string path = "";
        ...
        Debug.Log("About to generate a new BinaryFormatter");
        BinaryFormatter formatter = new BinaryFormatter();
        Debug.Log("About to generate the progress.dat file");
        FileStream stream = new FileStream(path + "progress.dat", FileMode.Create);
        Debug.Log("About to input experimental data information");
        ExpData data = new ExpData();
        data.id = subject;
        data.lastLevelFinished = levelNumber;
        data.levelNames = new List<string>();
        Debug.Log($"Did we input experimental data information\t{data.id}\t\n{data.lastLevelFinished}\t\n{levelNames}");
