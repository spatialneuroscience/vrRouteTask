...
public class LM_GoTo : ExperimentTask
{
    ...
    public override void TASK_START()
    {
        ...
        if (arriveAt.GetComponentInChildren<ParticleSystem>() != null)
    ...
    public override bool updateTask()
    {
        ...
        {
            if (atDestination &
                Mathf.Abs(Mathf.DeltaAngle(manager.playerCamera.transform.eulerAngles.y,
                    arriveAt.transform.eulerAngles.y)) < orientThreshold)
            {
                if (hud.GetMessage() == "")
                {
